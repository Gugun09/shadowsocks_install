...
#
# Copyright (C) 2016-2019 Gugun21 <Z@zeros.com>
#
...
error_detect_depends(){
    ...
    if [ $? -ne 0 ]; then
        ...
        echo 'Please visit: https://t.me/var_dump404 and contact.'
        exit 1
    fi
}
...
install_prepare_password(){
    ...
    read -p '(Default password: gugun):' shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd='gugun'
    echo
...
qr_generate_r(){
    if [ "$(command -v qrencode)" ]; then
        ...
        echo 'Config : http://$(get_ip):81/ss-r.png'
    fi
}
...
install_main(){
    ...
    echo
    echo 'Welcome to visit: https://t.me/var_dump404'
    echo 'Gugun21'
    echo 'Enjoy it!'
    echo
}
